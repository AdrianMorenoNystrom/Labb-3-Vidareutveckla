...
namespace VarmDrinkStation
{
    ...
    internal class Cappucino : IWarmDrink
    {
        public void Consume()
        {
            Console.WriteLine("Cappucino is served."); // Utskrift vid konsumtion av Cappucino
        }
    }
    ...
    internal class CoffeeFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            ...
            return new Coffee(); // Returnerar en ny instans av Kaffe
        }
    }
    ...
    internal class CappucinoFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Pour {total} ml Cappucino in your cup"); // Utskrift av mängden Cappucino som hälls upp
    ...
    internal class ChocolateFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            ...
            return new Chocolate(); // Returnerar en ny instans av Kaffe
        }
    }
